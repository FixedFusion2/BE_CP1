...
import random
print("\nWelcome to training, first I need to know some things about you.\n")
...
#Player Classes
fighter = {"Name": "Fighter","Health":10, "Attack": 10, "Defense":10}

wizard = {"Name": "Wizard","Health":5, "Attack": 15, "Defense":10}

cleric = {"Name": "Cleric","Health":15, "Attack": 5, "Defense":10}

#Moster Classes
kobold = {"Name": "Kobold","Health":15, "Attack": 5, "Defense":10}

goblin = {"Name": "Goblin","Health": 5, "Attack": 15, "Defense": 10}

bandit = {"Name": "Bandit","Health": 10, "Attack": 10, "Defense": 10}
...
def player_turn():
    ...
    if choice == "1":
        ...
        if hit >= monster ["Defense"]:
            ...
            (f"You hit {monster['Name']} for {damage} damage!")
        else:
            print("You missed!")
